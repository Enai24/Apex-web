...
type PositionType = 'unskilled' | 'semiskilled' | 'skilled' | 'supervisory' | 'managerial';
type LocationType = 'delhi' | 'mumbai' | 'bangalore' | 'chennai' | 'hyderabad' | 'pune' | 'others';

export default function CostCalculator() {
  const [formData, setFormData] = useState({
    employeeCount: 10,
    positionType: 'skilled' as PositionType,
  ...
  const positionRates: Record<PositionType, { min: number; max: number }> = {
                ...
                <dl className="space-y-4 text-sm leading-7 text-gray-600">
                  ...
                  <div className="flex gap-x-4">
                    ...
                    <div>
                      ...
                      <a className="hover:text-indigo-600" href="mailto:mail@apexenterprises.net">mail@apexenterprises.net</a>
                    </div>
                  </div>
                </dl>
              </div>
