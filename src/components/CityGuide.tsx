            ...
            <div className="prose prose-lg max-w-none">
              {cityData.content.split('\n').map((paragraph, index) => {
                if (paragraph.startsWith('#')) {
                  ...
                  const className = `${level === 1 ? 'text-3xl font-bold' : level === 2 ? 'text-2xl font-semibold mt-8' : 'text-xl font-medium mt-6'} tracking-tight text-gray-900`;
                  return React.createElement(tagName, { key: index, className }, text);
              ...
              <div>
                ...
                <dl className="mt-6 space-y-4 text-base leading-7 text-gray-600">
                  ...
                  <div className="flex gap-x-4">
                    ...
                    <dd>
                      <a className="hover:text-gray-900" href="mailto:mail@apexenterprises.net">
