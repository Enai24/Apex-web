...
import { ArrowRight, Crown, Shield, Target, Lock, Users, ChevronRight, Zap, Eye, Award, BarChart3 } from 'lucide-react';
        ...
        <section id="customers" className="py-24 bg-white border-y border-border">
          <div className="container">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 items-center grayscale opacity-70">
              {['Fortune 500 GCCs', 'Indian Conglomerates', 'Tech Unicorns', 'BFSI Leaders', 'Global MNCs', 'PSUs'].map((client, i) => (
