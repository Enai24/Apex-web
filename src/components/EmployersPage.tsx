  ...
  return (
    <div className="bg-background">
      ...
      <div className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="eyebrow">Why Choose Apex</h2>
              ...
              {whyWorkWithUs.map((item) => (
                <div key={item.title} className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-xl font-semibold leading-7 text-gray-900">
                    <div className="flex h-12 w-12 items-center justify-center rounded-sm bg-muted text-orange-red">
      ...
      <div className="bg-gray-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="eyebrow">Flexible Engagement</h2>
            <p className="mt-2 text-3xl font-medium tracking-tight text-navy sm:text-4xl">
          ...
          <div className="mx-auto mt-16 grid max-w-lg gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            {pricingModels.map((model) => (
              <div key={model.title} className="card p-8 hover:shadow-card transition-shadow">
                ...
                <ul className="mt-8 space-y-3">
                  {model.features.map((feature) => (
                    <li key={feature} className="flex gap-x-3">
                      <Check className="h-6 w-5 flex-none text-orange-red" />
          ...
          <div className="mt-10 flex justify-center">
            <Link href="/contact" className="text-base font-medium text-orange-red hover:opacity-80 flex items-center">
            ...
            <div>
              ...
              <dl className="mt-10 space-y-6">
                <div className="flex gap-x-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-muted text-orange-red flex-none">
