        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-4xl lg:text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="/contact?location=bangalore"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3">
            ...
            <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              ...
              <Link href="/services/contract-staffing" className="mt-6 text-sm font-semibold leading-6 text-blue-600 flex items-center">
            ...
            <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              ...
              <Link href="/services/specialised-hiring" className="mt-6 text-sm font-semibold leading-6 text-blue-600 flex items-center">
                Learn more <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
            ...
            <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              ...
              <Link href="/ai-resume-screening" className="mt-6 text-sm font-semibold leading-6 text-blue-600 flex items-center">
                Learn more <ArrowRight className="ml-1 h-4 w-4" />
              </Link>
            </div>
          </div>
