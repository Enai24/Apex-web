                  ...
                  <div className="space-y-4">
                    {upcomingTasks.map((task) => (
                      <div key={task.id} className="flex items-center">
                        <div className={`flex-shrink-0 w-2 h-2 rounded-full ${task.type === 'call' ? 'bg-green-400' :
                  ...
                  <div className="space-y-4">
                    {recentActivities.map((activity) => (
                      <div key={activity.id} className="flex items-start">
                        <div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${activity.type === 'lead' ? 'bg-green-100' :
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                              {agent.benefits.slice(0, 2).map((benefit: string, idx: number) => (
                                <span
                                  key={idx}
